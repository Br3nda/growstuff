  ...
  context 'when signed in' do
    ...
    describe 'expand menus' do
      it 'expands crop menu' do
        visit root_path
        click_on 'Crops'
        Percy.snapshot(page, name: "#{prefix}/crops-menu", widths: [1280])
        click_on 'Community'
        Percy.snapshot(page, name: "#{prefix}/community-menu", widths: [1280])
        click_on 'percy'
        Percy.snapshot(page, name: "#{prefix}/member-menu", widths: [1280])
      end
    end
  end
